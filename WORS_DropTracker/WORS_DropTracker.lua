...
local function CreateLootTrackerUI()
	...
	if IsAddOnLoaded("WORSLite") then
		...
		WORS_DropTracker:SetMinResize(100, 100)  
		WORS_DropTracker:SetMaxResize(600, 600)		
	...
	if event == "PLAYER_LOGIN" then	
		...
		if IsAddOnLoaded("WORSLite") then
			...
			if btn then
				...
				SLASH_WORSDROP1 = "/droptracker"
				SlashCmdList.WORSDROP = function()
...
-- Minimap Icon for WORS_DropTracker if sidebar is not enabled using LibDBIcon and Ace3
